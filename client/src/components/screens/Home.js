            ...
            <div className={classes.main}>
                {
                    data.map(item=>{
                        ...
                        return (
                            ...
                            <div className={classes.ImageContentdiv}>
                                ...
                                <Link to={item.postedBy._id !== state._id?"/profile/"+item.postedBy._id:"/profile/"}>
                                    <img className={classes.Image} src={item.postedBy.pic} alt="shfhs"></img>
                                </Link>
                                </div>
                        <div className={classes.Content}>
                            ...
                            <img className="activator" style={{width:"90%",margin:"40px"}} src={item.photo}></img>
                            </div>
                            ...
                            <div className="card-content input-field">
                                <span className="card-title activator grey-text text-darken-4">
                                    ...
                                    {item.likes.includes(state._id)?
                                            <i className="material-icons right" onClick={()=>{unlikePost(item._id)}}>thumb_down</i>

                                        : <i className="material-icons right"onClick={()=>{likePost(item._id)}}>thumb_up</i>
                                    }
